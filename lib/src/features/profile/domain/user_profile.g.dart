...
UserProfile _userProfileDeserialize(
  ...
  final object = UserProfile(
    currencyCode: reader.readStringOrNull(offsets[0]) ?? 'IDR',
    email: reader.readStringOrNull(offsets[1]),
    name: reader.readStringOrNull(offsets[2]) ?? 'User',
    profileImagePath: reader.readStringOrNull(offsets[3]),
  );
  object.id = id;
  return object;
}
...
P _userProfileDeserializeProp<P>(
  ...
  switch (propertyId) {
    case 0:
      return (reader.readStringOrNull(offset) ?? 'IDR') as P;
    case 1:
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByCurrencyCode() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByCurrencyCode() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'currencyCode', Sort.asc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByCurrencyCode(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByProfileImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, String, QQueryOperations> currencyCodeProperty() {
    return QueryBuilder.apply(this, (query) {
