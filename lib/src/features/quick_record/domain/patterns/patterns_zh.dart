...
const Map<String, CategoryPattern> mandarinPatterns = {
  ...
  'Housing': CategoryPattern(
    ...
    subCategoryKeywords: {
      'Rent': ['房租', '租金'],
      'Mortgage': ['房贷', '按揭'],
      'Utilities': ['水电费', '电费', '水费', '燃气费', '暖气费', '物业费'],
      'Internet': ['网费', '宽带', '话费', '流量'],
      'Maintenance': ['维修', '装修', '家具维修'],
      'Furniture': ['家具', '家电', '床', '沙发', '桌椅'],
      'Services': ['家政', '保洁', '保安费'],
    },
  ),
  'Shopping': CategoryPattern(
    mainKeywords: ['购物', '买东西'],
    subCategoryKeywords: {
      'Clothes': ['衣服', '服装', '鞋子', '裤子', '外套', '内衣', '裙子'],
      'Electronics': ['电子产品', '手机', '电脑', '数码', '耳机'],
      'Home': ['日用品', '生活用品', '杂货'],
      'Beauty': ['美容', '化妆品', '理发', '护肤', '美发'],
      'Gifts': ['礼物', '礼品', '红包'],
      'Software': ['软件', 'APP', '订阅', '会员'],
      'Tools': ['工具', '文具'],
    },
  ),
